...
<div class="row main-icon-banner">
    ...
    <img onclick="openTab('10')" class="icon  icon-tab icon-10" src="/frontend/image/icon-diem-thi-tuyen-sinh.png">
    <img onclick="openTab('news')" class="icon  icon-tab icon-news" src="/frontend/image/icon-tin-tuc.png">
</div>
<div class="row main-form-search">
    <form method="GET" action="" class="diem-tot-nghiep">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <input name="sbd" class="form-control input-sbd" value="<?php echo e(isset($_GET['sbd']) ? $_GET['sbd'] : ''); ?>" type="text" placeholder="Số báo danh" required />
            </div>
        </div>
    ...
    <form method="GET" action="" class="tuyen-sinh-lop10 _hidden">
...
<div class="row">
    ...
    <?php echo $__env->make('frontend.element.home.phodiemMobile', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
