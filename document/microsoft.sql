...
CREATE TABLE `block_item` (
  ...
  `input_type` text COLLATE utf8_unicode_ci,
...
--
-- Cấu trúc bảng cho bảng `diem_thi_thpt`
--
...
CREATE TABLE `diem_thi_thpt` (
  ...
  `diem` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `stt` int(11) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `diem_thi_thpt`
--

INSERT INTO `diem_thi_thpt` (`id`, `ten`, `parent_id`, `sort_order`, `created_at`, `updated_at`, `sbd`, `ho`, `diem`, `stt`) VALUES
(1, 'TiếnLQ', 0, 0, '2019-05-04 04:50:43', '2019-05-05 02:44:20', '1', 'Lưu', '9', 0),
(2, 'Tiến1', 0, 0, '2019-05-05 02:44:12', '2019-05-05 02:44:12', '2', 'Lưu1', '10', 0),
(3, 'TiếnLQ', 0, 0, NULL, NULL, '1', 'Lưu', '9', 1),
(4, 'Tiến1', 0, 0, NULL, NULL, '2', 'Lưu1', '10', 2),
(5, 'TiếnLQ', 0, 0, NULL, NULL, '1', 'Lưu', '9', 1),
(6, 'Tiến1', 0, 0, NULL, NULL, '2', 'Lưu1', '10', 2);
...
(12, 4, 'product', 'Quản lí sản phẩm', 1, 'BASIC', 30, 'Product', 0, 1, 0, 0, '2019-02-12', '2019-04-01'),
(14, 6, 'news', 'Quản lí tin tức', 1, NULL, 30, NULL, 0, 1, 0, 0, '2019-03-19', '2019-04-01'),
(16, 3, 'category', 'QL danh mục', 1, '1', 30, NULL, 0, 2, 0, 0, '2019-03-30', '2019-05-01'),
(24, 1, 'route', 'route', 0, '1', 30, NULL, 26, 2, 0, 0, '2019-04-01', '2019-05-01'),
(26, 9, 'tables', 'Category', 0, '1', 30, 'Tables', 0, 1, 0, 0, '2019-02-21', '2019-02-21'),
(27, 8, 'configweb', 'Cấu hình website', 1, '5', 30, NULL, 0, 1, 0, 0, '2019-04-06', '2019-05-01'),
(28, 7, 'contact', 'Thư gửi liên hệ', 1, NULL, 30, NULL, 0, 1, 0, 0, '2019-04-07', '2019-04-07'),
(31, 2, 'block_item', 'block_item', 0, '1', 30, 'block_item', 34, 1, 0, 0, '2019-04-15', '2019-05-01'),
(32, 1, 'block', 'block', 0, '1', 30, NULL, 34, 2, 0, 0, '2019-04-15', '2019-05-01'),
(33, 5, 'landing_page_item', 'landing_page_item', 0, NULL, 30, 'landingpageItem', 0, 1, 0, 0, '2019-04-15', '2019-05-01'),
(34, 3, 'landing_page', 'landingpage', 1, NULL, 30, 'landingpage', 26, 1, 0, 0, '2019-04-15', '2019-04-28'),
(35, 2, 'users', 'Quản lý User', 0, NULL, 30, NULL, 26, 2, 0, 0, '2019-05-01', '2019-05-01'),
(36, 2, 'footer', 'Nội dung phần chân website', 1, '1', 30, NULL, 0, 2, 0, 0, '2019-05-01', '2019-05-01'),
(37, 1, 'diem_thi_thpt', 'Điểm thi THPT', 1, '0', 30, NULL, 0, 1, 1, 1, '2019-05-04', '2019-05-05');
...
(10, 12, 'Tên Sản Phẩm', 'name', 'VARCHAR', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 1, 1, 0, '2019-03-18', '2019-04-15', 0, NULL, 0),
(11, 12, 'Hình ảnh đại diên', 'image', 'VARCHAR', NULL, 1, NULL, 1, NULL, 0, 1, 'image_laravel', 0, 1, 3, 0, '2019-03-18', '2019-05-04', 0, NULL, 0),
(12, 12, 'Nội dung', 'content', 'LONGTEXT', NULL, 1, NULL, 1, NULL, 0, 1, 'summoner', 0, 1, 5, 0, '2019-03-18', '2019-04-15', 0, NULL, 0),
(13, 12, 'Nội dung tóm tắt', 'summary', 'TEXT', NULL, 1, NULL, 1, NULL, 0, 1, 'summoner', 0, 1, 6, 0, '2019-03-18', '2019-04-15', 0, NULL, 0),
...
(19, 12, 'sort_order', 'sort_order', 'INT', NULL, 1, NULL, 1, NULL, 0, 1, 'text', 0, 1, 9, 0, '2019-03-19', '2019-05-04', 0, NULL, 0),
...
(26, 16, 'parent_id', 'parent_id', 'INT', NULL, 1, NULL, 1, NULL, 1, 1, 'select', 1, 0, 3, 0, '2019-03-30', '2019-04-29', 16, NULL, 0),
...
(49, 16, 'Chọn kiểu hiển thị', 'route_id', 'INT', NULL, 1, NULL, 1, NULL, 0, 1, 'select', 0, 1, 2, 0, '2019-04-01', '2019-04-07', 24, NULL, 0),
...
(60, 27, 'name', 'name', 'VARCHAR', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 1, 0, 0, '2019-04-06', '2019-04-06', 0, NULL, 0),
(61, 27, 'address', 'address', 'VARCHAR', NULL, 1, NULL, 1, NULL, 0, 1, 'text', 1, 1, 0, 0, '2019-04-06', '2019-04-06', 0, NULL, 0),
(62, 27, 'email', 'email', 'VARCHAR', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 1, 0, 0, '2019-04-06', '2019-04-06', 0, NULL, 0),
(63, 27, 'logo', 'logo', 'VARCHAR', NULL, 1, NULL, 1, NULL, 0, 1, 'image_laravel', 0, 1, 0, 0, '2019-04-06', '2019-04-06', 0, NULL, 0),
(67, 27, 'facebook', 'facebook', 'VARCHAR', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 1, 0, 0, '2019-04-06', '2019-04-06', 0, NULL, 0),
(68, 27, 'youtube', 'youtube', 'VARCHAR', NULL, 1, NULL, 1, NULL, 0, 1, 'text', 0, 1, 0, 0, '2019-04-06', '2019-04-06', 0, NULL, 0),
(69, 27, 'instagram', 'instagram', 'VARCHAR', NULL, 1, NULL, 1, NULL, 0, 1, 'text', 0, 1, 0, 0, '2019-04-06', '2019-04-06', 0, NULL, 0),
(70, 27, 'phone', 'phone', 'INT', NULL, 1, NULL, 1, NULL, 0, 1, 'text', 0, 0, 0, 0, '2019-04-06', '2019-04-07', 0, NULL, 0),
(72, 28, 'name', 'name', 'VARCHAR', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 1, 0, 0, '2019-04-07', '2019-04-07', 0, NULL, 0),
(73, 28, 'phone', 'phone', 'INT', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 1, 0, 0, '2019-04-07', '2019-04-07', 0, NULL, 0),
(74, 28, 'email', 'email', 'VARCHAR', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 0, 0, 0, '2019-04-07', '2019-04-07', 0, NULL, 0),
(75, 28, 'address', 'address', 'VARCHAR', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 1, 0, 0, '2019-04-07', '2019-04-07', 0, NULL, 0),
(76, 12, 'Hình ảnh SP', 'images', 'LONGTEXT', NULL, 1, NULL, 1, NULL, 0, 1, 'images', 0, 0, 4, 0, '2019-04-07', '2019-05-04', 0, NULL, 0),
(80, 12, 'chọn danh mục', 'category_id', 'INT', NULL, 1, NULL, 1, NULL, 0, 1, 'select', 0, 0, 2, 0, '2019-04-07', '2019-05-04', 16, NULL, 0),
...
(125, 16, 'Thứ tự sắp sếp', 'sort_order', 'INT', NULL, 1, NULL, 0, NULL, 0, 1, 'text', 0, 0, 6, 0, '2019-04-29', '2019-04-29', 0, NULL, 0),
...
(139, 37, 'Danh mục cha', 'parent_id', 'INT', '0', 1, NULL, 0, NULL, 0, 1, 'text', 0, 0, 7, 0, '2019-05-04', '2019-05-04', 0, NULL, 0),
(140, 37, 'Thứ tự sắp sếp', 'sort_order', 'INT', '0', 1, NULL, 0, NULL, 0, 1, 'text', 0, 0, 8, 0, '2019-05-04', '2019-05-04', 0, NULL, 0),
(141, 16, '[SEO] Từ khóa', 'seo_keyword', 'TEXT', NULL, 1, NULL, 1, NULL, 0, 1, 'number', 0, 0, 4, 0, '2019-05-04', '2019-05-04', 0, NULL, 0),
(142, 16, '[SEO] Mô tả', 'seo_description', 'TEXT', NULL, 1, NULL, 1, NULL, 0, 1, 'text', 0, 0, 5, 0, '2019-05-04', '2019-05-04', 0, NULL, 0),
(143, 12, '[SEO] Từ khóa', 'seo_keyword', 'TEXT', NULL, 1, NULL, 1, NULL, 0, 1, 'textarea', 0, 0, 7, 0, '2019-05-04', '2019-05-04', 0, NULL, 0),
(144, 12, '[SEO] Mô tả', 'seo_description', 'TEXT', NULL, 1, NULL, 1, NULL, 0, 1, 'textarea', 0, 0, 8, 0, '2019-05-04', '2019-05-04', 0, NULL, 0),
...
(150, 37, 'Điểm', 'diem', 'VARCHAR', NULL, 1, NULL, 1, NULL, 1, 1, 'text', 1, 1, 5, 0, '2019-05-04', '2019-05-05', 0, NULL, 0),
(151, 37, 'stt', 'stt', 'INT', '0', 1, 11, 0, NULL, 0, 1, 'text', 0, 0, 6, 0, '2019-05-05', '2019-05-05', 0, NULL, 0);
...
--
-- Chỉ mục cho bảng `diem_thi_thpt`
--
...
ALTER TABLE `contact`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT cho bảng `diem_thi_thpt`
--
ALTER TABLE `diem_thi_thpt`
